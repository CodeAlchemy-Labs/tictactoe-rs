...
//!
//! This module is free of any I/O, async, or transport concern. It models the
//! board, the players, and the win/draw detection rules as a small set of
//! value objects and one aggregate ([`Board`]) that owns its invariants.
//!
